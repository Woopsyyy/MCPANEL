...
export class CommandRouter {
  ...
  public getHelpText(): string {
    return [
      ...
      '',
      colors.bold(colors.green('Dashboard (Web UI)')),
      '  dashboard                    - Launch the realtime web dashboard in your browser',
      '  dashboard stop               - Stop the web dashboard server',
      '  dashboard status             - Show the dashboard URL and whether it is running',
      '',
